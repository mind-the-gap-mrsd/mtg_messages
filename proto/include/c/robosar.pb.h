...
#define robosar_fms_SensorData_init_default      {0, false, robosar_fms_Accelerometer_init_default, false, robosar_fms_Gyroscope_init_default, false, robosar_fms_Encoder_count_init_default, false, robosar_fms_Encoder_speed_init_default, false, robosar_fms_Infrared_init_default, false, robosar_fms_Ultrasonic_init_default}
...
#define robosar_fms_SensorData_init_zero         {0, false, robosar_fms_Accelerometer_init_zero, false, robosar_fms_Gyroscope_init_zero, false, robosar_fms_Encoder_count_init_zero, false, robosar_fms_Encoder_speed_init_zero, false, robosar_fms_Infrared_init_zero, false, robosar_fms_Ultrasonic_init_zero}
...
#define robosar_fms_SensorData_accel_data_tag    2
#define robosar_fms_SensorData_gyro_data_tag     3
#define robosar_fms_SensorData_count_data_tag    4
#define robosar_fms_SensorData_speed_data_tag    5
#define robosar_fms_SensorData_ir_data_tag       6
#define robosar_fms_SensorData_us_data_tag       7
...
X(a, STATIC,   SINGULAR, UINT32,   sensor_a,          1) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_b,          2) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_c,          3) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_d,          4) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_e,          5)
...
X(a, STATIC,   SINGULAR, UINT32,   sensor_d,          4) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_e,          5) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_f,          6) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_g,          7) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_h,          8) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_i,          9) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_j,         10) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_k,         11) \
X(a, STATIC,   SINGULAR, UINT32,   sensor_l,         12)
...
X(a, STATIC,   SINGULAR, DOUBLE,   gyro_x,            1) \
X(a, STATIC,   SINGULAR, DOUBLE,   gyro_y,            2) \
X(a, STATIC,   SINGULAR, DOUBLE,   gyro_z,            3)
...
X(a, STATIC,   SINGULAR, UINT64,   left,              1) \
X(a, STATIC,   SINGULAR, UINT64,   right,             2)
...
X(a, STATIC,   OPTIONAL, MESSAGE,  accel_data,        2) \
X(a, STATIC,   OPTIONAL, MESSAGE,  gyro_data,         3) \
X(a, STATIC,   OPTIONAL, MESSAGE,  count_data,        4) \
X(a, STATIC,   OPTIONAL, MESSAGE,  speed_data,        5) \
X(a, STATIC,   OPTIONAL, MESSAGE,  ir_data,           6) \
X(a, STATIC,   OPTIONAL, MESSAGE,  us_data,           7)
...
#define robosar_fms_SensorData_size              223
