...
#ifndef PB_ROBOSAR_FMS_ROBOSAR_MESSAGES_PROTO_ROBOSAR_PB_H_INCLUDED
#define PB_ROBOSAR_FMS_ROBOSAR_MESSAGES_PROTO_ROBOSAR_PB_H_INCLUDED
#include <pb.h>
...
#define robosar_fms_SensorData_init_default      {0, robosar_fms_Accelerometer_init_default, robosar_fms_Gyroscope_init_default, robosar_fms_Encoder_count_init_default, robosar_fms_Encoder_speed_init_default, robosar_fms_Infrared_init_default, robosar_fms_Ultrasonic_init_default}
...
#define robosar_fms_SensorData_init_zero         {0, robosar_fms_Accelerometer_init_zero, robosar_fms_Gyroscope_init_zero, robosar_fms_Encoder_count_init_zero, robosar_fms_Encoder_speed_init_zero, robosar_fms_Infrared_init_zero, robosar_fms_Ultrasonic_init_zero}
...
X(a, STATIC,   REQUIRED, MESSAGE,  accel_data,        2) \
X(a, STATIC,   REQUIRED, MESSAGE,  gyro_data,         3) \
X(a, STATIC,   REQUIRED, MESSAGE,  count_data,        4) \
X(a, STATIC,   REQUIRED, MESSAGE,  speed_data,        5) \
X(a, STATIC,   REQUIRED, MESSAGE,  ir_data,           6) \
X(a, STATIC,   REQUIRED, MESSAGE,  us_data,           7)
